요청하신 대로 **프로젝트의 기술적 깊이(알고리즘, 수치, 아키텍처)**와 **상세 기능**을 모두 포함하여, 포트폴리오나 깃허브 메인에 바로 사용할 수 있는 고품질의 `README.md`를 작성해 드립니다.

업로드해주신 PDF의 모든 기술적 세부 사항(가중치 공식, RAG 파이프라인 구조, 평가 지표 등)을 빠짐없이 반영했습니다.
